...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const selectItem = document.querySelector('option').selected;
  const oneRight = document.querySelector('.js-item-to-right');
  const allRight = document.querySelector('.js-item-to-right-all');
  const oneLeft = document.querySelector('.js-item-to-left');
  const allLeft = document.querySelector('.js-item-to-left-all');
